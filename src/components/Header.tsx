    ...
    return (
        <div className="header">
            ...
            <div style={{ width: "60%", display: "flex" }}>
                <Link to="/PasangIklan" className="header-item" style={{ backgroundColor: "#fae7a8", color: "#7b5533", textDecoration: "none" }}>
                    Pasang Iklan 🔥
                </Link>
            </div>
            {/* Account */}
            <div style={{ width: "20%", display: "flex", borderRadius: "2em;" }}>
                <div className="header-button" style={{ padding: "0.3em" }}>
